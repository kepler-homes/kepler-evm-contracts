...
contract SwapPair is ISwapPair {
    ...
    string public constant override name = "Swap LP Token";
    string public constant override symbol = "WLP";
        ...
        returns (uint256 liquidity)
    {
        ...
        if (_totalSupply == 0) {
            ...
            if (msg.sender == migrator) {
                ...
                liquidity = SwapMath.sqrt(amount0.mul(amount1)).sub(
                    MINIMUM_LIQUIDITY
                );
            }
        } else {
    ...
    function swap(
        ...
        require(
            !onlyWhiteContract || whiteContracts[msg.sender],
            "Swap: FORBIDDEN"
        );
        require(
    ...
    function setWhiteContracts(address contractAddress, bool enabled)
        external
        override
        onlyFactory
    {
    ...
    function isWhiteContracts(address contractAddress)
        external
        view
        override
        returns (bool)
